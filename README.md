...
- 마음에 든 작가를 담아 두고, **갈래**를 붙여 나눕니다 (「두꺼운 선」 「수채」 처럼
  직접 이름 짓습니다). 즐겨찾기(★)와 이름 검색으로 좁혀 봅니다
- 눌러서 **섞기**에 넣고, 작가마다 **세기**를 슬라이더로 정합니다
...
| `test_danbooru.js` | Danbooru 조회 (주소·응답 해석·반영율·작가 통계) | 67 |
| `test_artists.js` | 작가 서랍 (갈래·즐겨찾기·세기 배분·프롬프트 굽기) | 44 |
